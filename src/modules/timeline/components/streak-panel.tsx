...
export function StreakPanel({ current, longest, totalActiveDays, mostActiveDay, mostActiveDayMsgs }: Props) {
  return (
    <div className="grid grid-cols-2 gap-3 text-[13px]">
      ...
      <div className="border border-border rounded p-3 bg-card">
        ...
        <p className="text-2xl font-bold text-[#1d4ed8] dark:text-[#60a5fa]">{longest}</p>
        <p className="text-muted-foreground/60 text-[12px]">consecutive days</p>
      </div>
      <div className="border border-border rounded p-3 bg-card">
      ...
      {mostActiveDay && (
        <div className="border border-border rounded p-3 bg-card">
          ...
          <p className="text-sm font-bold text-[#047857] dark:text-[#34d399]">{mostActiveDay}</p>
